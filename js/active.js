(function ($) {
    ...
    var proCata = $('.mobhome-pro-catagory');
    ...
    var mobhomeSearch = $('.search-nav');
    var searchClose = $('.search-close');

    mobhomeSearch.on('click', function () {
    ...
    var mobhomeMobNav = $('.mobhome-navbar-toggler');
    var navClose = $('.nav-close');

    mobhomeMobNav.on('click', function () {
